...
public final class StdRandom {
	...
	public static boolean bernoulli(double p) {
		if (!(p >= 0.0 && p <= 1.0)) throw new IllegalArgumentException("probability p must be between 0.0 and 1.0");
		return uniform() < p;
	}
	...
	public static int poisson(double lambda) {
		...
		if (Double.isInfinite(lambda)) throw new IllegalArgumentException("lambda must not be infinite");
		// using algorithm given by Knuth
	...
	public static double pareto(double alpha) {
		if (!(alpha > 0.0)) throw new IllegalArgumentException("alpha must be positive");
	 ...
	 * @throws IllegalArgumentException
	 * 		if {@code frequencies[i]} is negative for any index {@code i}
	 * @throws IllegalArgumentException
	 * 		if sum of frequencies exceeds {@code Integer.MAX_VALUE} (2<sup>31</sup> - 1)
	 */
